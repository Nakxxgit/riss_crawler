...
def load_degree(driver, page, keyword):
...
if __name__ == "__main__":
    ...
    driver.get('http://www.riss.kr/search/Search.do?detailSearch=false&viewYn=OP&queryText=&iGroupView=5&icate=all&colName=bib_t&pageScale=1000&strSort=RANK&order=%2FDESC&query='+keyword+'&iStartCount='+str(0))
