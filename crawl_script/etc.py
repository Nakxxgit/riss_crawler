...
def load_etc(driver, page, keyword):

    url = 'http://www.riss.kr/search/Search.do?detailSearch=false&viewYn=OP&queryText=&iGroupView=5&icate=all&colName=re_t&pageScale=1000&strSort=RANK&order=%2FDESC&query='
    url2 = '&iStartCount='
...
if __name__ == '__main__':
    ...
    driver.get('http://www.riss.kr/search/Search.do?detailSearch=false&viewYn=OP&queryText=&iGroupView=5&icate=all&colName=re_t&pageScale=1000&strSort=RANK&order=%2FDESC&query=' + keyword + '&iStartCount=' + str(0))
